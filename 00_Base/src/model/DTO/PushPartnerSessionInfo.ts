 ...
 */
export const PushPartnerSessionInfoBodySchema = z.object({
...
export type PushPartnerSessionInfoSummary = {
  module: string;
  processed: number;
...
export const PushPartnerSessionInfoSummarySchema = z.object({
  module: z.string(),
  processed: z.number(),
